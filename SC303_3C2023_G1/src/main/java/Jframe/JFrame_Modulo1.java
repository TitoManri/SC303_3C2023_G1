...
public class JFrame_Modulo1 extends javax.swing.JFrame {
    ...
    private RegistroUsuarios registro;  // Se agrega el registro de usuarios

    public JFrame_Modulo1() {
        initComponents();
        registro = new RegistroUsuarios(); // Inicializamos el registro de usuarios
        jTextField5.setVisible(false); // iniciamos en false para que se vean al interactuar con boton inactivar
        jLabel5.setVisible(false); // iniciamos en false para que se vean al interactuar con boton inactivar
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Nickname para inactivar:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Usuario usuario = new Usuario(nombre, apellidos, nickname, password);
        registro.agregarUsuario(usuario);

        actualizarListaUsuarios();
    }//GEN-LAST:event_jButton1ActionPerformed
    
    // boton Inactivar por Nickname
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        jTextField5.setVisible(true);
        jLabel5.setVisible(true);  
        String nickname = jTextField5.getText(); // Usamos el nuevo campo de texto para obtener el nickname
    
    if (registro.inactivarUsuario(nickname)) {
        jTextArea1.append("\nUsuario " + nickname + " ha sido inactivado.");
    } else {
        jTextArea1.append("\nNo se encontró el usuario con el nickname " + nickname + " o ya estaba inactivo.");
    }
    ...
    private void actualizarListaUsuarios() {
        jTextArea1.setText(registro.mostrarUsuarios());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Modulo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_Modulo1().setVisible(true);
            }
        });
    }
