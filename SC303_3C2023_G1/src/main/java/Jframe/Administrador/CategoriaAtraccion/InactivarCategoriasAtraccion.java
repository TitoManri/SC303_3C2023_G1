 ...
 * @author manri
 */
public class InactivarCategoriasAtraccion extends javax.swing.JFrame {

    /**
     * Creates new form InactivarCategoriasAtraccion
     */
    public InactivarCategoriasAtraccion() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InactivarCategoriasAtraccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InactivarCategoriasAtraccion().setVisible(true);
            }
        });
    }
