 ...
 * @author manri
 */
public class EditarAtracciones extends javax.swing.JFrame {

    /**
     * Creates new form EditarAtracciones
     */
    public EditarAtracciones() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarAtracciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarAtracciones().setVisible(true);
            }
        });
    }
