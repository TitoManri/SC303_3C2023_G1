 ...
 * @author manri
 */
public class InactivarAtracciones extends javax.swing.JFrame {

    /**
     * Creates new form InactivarAtracciones
     */
    public InactivarAtracciones() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InactivarAtracciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InactivarAtracciones().setVisible(true);
            }
        });
    }
